...
const ProtectorPhone2Screen = ({ route, navigation }) => {
    ...
    useEffect(() => {
        const {UserId, UserName, Email, Password, WardName, WardNum} = route.params;
        setUserId(UserId);
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <AntDesign name='left' size={25} style={{ marginHorizontal: 10 }} onPress={() => navigation.navigate('ProtectorForm', {WardName, WardNum})} />
...
export default ProtectorPhone2Screen;